...
@Component({
    ...
    <div class="col-xs-12">
        ...
        <img src="../../../assets/images/overview.jpg" alt="" class="mb-2 img-responsive">
        <img src="../../../assets/images/duplicates.jpg" alt="" class="mb-2 img-responsive">
        <img src="../../../assets/images/settings.jpg" alt="" class="mb-2 img-responsive">
        <img src="../../../assets/images/repos.jpg" alt="" class="mb-2 img-responsive">
        </div>
    </div>
</div>
    `,
